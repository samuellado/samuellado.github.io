...
Ayala-García, A.; Lado, S.; Serra-Saurina, L.; Silva, J. I. (2026). Labour market flows and the child penalty: Evidence from Spanish administrative records, mimeo [submitted]. 
<details>
<summary>Abstract</summary>
Which labour market flows generate the gender gaps that open around childbirth? Using monthly Spanish administrative records for 79,515 mothers and 129,669 fathers over the decade before and after a first birth, we classify individuals into five administratively defined states and model their movements with a time-varying Markov chain. Because state shares are generated by the full history of monthly flows, we decompose the observed gender gap at every event month into the contribution of the initial distribution and of each of the twenty transition types, using dynamic Shapley values. Gender differences in entry into full-time employment, from administrative non-affiliation, unemployment and part-time work, account for 67 and 68 per cent of the full-time gap in the medium and long run, against 30 and 23 per cent for exits from full-time work. Childbirth amplifies asymmetries that are already present before conception.
</details>
